...
<?php		
		MP_Mailinglists::dropdown(array('name' => "description[settings][{$this->id}][mailinglist_id]", 'htmlid' => "autoresponder_mailinglist_{$this->id}", 'selected' => $mailinglist_id, 'hierarchical' => true, 'orderby' => 'name', 'hide_empty' => '0'));
?>
