<?php
function theme_shortcode_installazioni($atts, $content = null, $code) {
	...
	$query = array('post_type' => 'installazioni','posts_per_page' => $count, 'orderby'=> 'date', 'post_status' => 'publish');
	if($cat){
		$query['cat'] = $cat;
	}
...
add_shortcode('installazioni', 'theme_shortcode_installazioni');
